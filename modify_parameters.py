...
def fitA(parameter):
    ...
    tem_par[9]=parameter[9]
    tem_par[10]=parameter[10]
    tem_par[11]=parameter[11]
    return tem_par
...
def fitABCD(parameter):
    tem_par=[0]
    for j in range(11):
        tem_par.append(0)
    tem_par[0]=parameter[9]
    tem_par[1]=parameter[10]
    tem_par[2]=parameter[11]
    tem_par[3]=parameter[0]
    tem_par[4]=parameter[1]
    tem_par[5]=parameter[2]
    tem_par[6]=parameter[3]
    tem_par[7]=parameter[4]
    tem_par[8]=parameter[5]
    tem_par[9]=parameter[6]
    tem_par[10]=parameter[7]
    tem_par[11]=parameter[8]
    return tem_par
